...
export async function handleDocumentRequest(request) {
    ...
    const html = renderToString(_jsx(StrictMode, { children: _jsx(StaticRouterProvider, { router: router, context: context }) }));
